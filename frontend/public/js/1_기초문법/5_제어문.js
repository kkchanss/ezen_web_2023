/*
	...
	- 제어문 = if = 만약에
		ex) 동생(컴퓨터)에게 집 앞에 있는 A,B,C편의점에서 1000원 주고 콜라 사오기 심부름
...
if( 10 > 20 ){
	console.log('참5'); console.log('참6'); // 거짓이면 둘다 출력x (의도와 같음)
}  
...
else if( 10 >= 10) { console.log('[참3] 10이 10보다 이상이다'); } // 참이면 실행 후 전체 if 종료
