package java1.day1; // 현재 클래스 패키지경로
...
public class Ex2_타입 { // class s
	...
	public static void main(String[] args) { // m s
		...
		int var1 = 0b1011; // (2진수) 데이터 앞에 0b 		1011[2] => 11
		...
		//byte b3 = 128; System.out.println("b3 : " + b3); // 오류 : 허용 범위 벗어남
		...
		//long l2 = 30000000000; System.out.println("l2 : " + l2); // 직접 작성한 정수 30억은 int 타입 -> 기본
		...
		// [ p.45 ] 
		// float 타입 [ 소수 8자리 표현 ] // 데이터 뒤에 f
		float f1 = 0.123456789123456789f;
		System.out.println("f1 : " + f1);
		
		// double [ 소수 17자리 표현 ] : *실수 기본 타입
...
/*
	...
	// 용량단위 :
		(처리 최소 단위) 0,1 -> 1bit		-> 01010101 -> 8자리 -> 8bit -> 1byte
		(저장 최소 단위) 1byte -> 1024byte -> 1kbyte
		1kb -> 1024kb -> 1mb
		1mb -> 1024mb -> 1gb

	// 인코딩 : 2진수를 문자로 표현하는 방법
	 	컴퓨터 : 010101010101 --> 사람 : ??????????
	 	컴퓨터 : 010101010101 --> 규칙/패턴/해독 ( 인코딩 ) ---> ABC 
