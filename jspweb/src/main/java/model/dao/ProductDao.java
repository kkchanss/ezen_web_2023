...
public class ProductDao extends Dao {
	...
	// 1. 제품 전체 출력 
	public ArrayList<ProductDto> selectAll(){return null;}
	// 2. 해당 지역 제품 출력
	public ArrayList<ProductDto> selectLocation(double e,double w,double s,double n) {return null;}
	// 3. 제품 개별 조회 
	public ProductDto selectOne(int pno) {return null;}
	// 4. 관리 제품 출력
	public ArrayList<ProductDto> selectAdmin(int listsize, int startlist){return null;}
